                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="Doctorlogin.aspx">Dlogin</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="Doctorregistration.aspx">Doctorregistration</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="patientbook.aspx">Booking</a>
                            </li>
